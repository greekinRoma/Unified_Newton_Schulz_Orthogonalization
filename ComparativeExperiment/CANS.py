...
def cans_iteration(A, n, a_index, degree=3, preprocess=False, preprocess_iters=4, delta=0.99):
...
def curve_iteration(a, n, a_index, degree=3, preprocess=False, preprocess_iters=4, delta=0.99):
    b_index = 1
    e = 10
    if preprocess:
        lst, _ = delta_orthogonalization(preprocess_iters, degree, delta)
